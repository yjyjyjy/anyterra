locals {
  resource_prefix               = "deliberate"
  sqs_queue_prefix              = "deliberate_queue"
  free_queues_resource_prefix   = "deliberate_queue_free"
  premium_queue_resource_prefix = "deliberate_queue_premium"
...
locals {
  ...
  task_manager_docker_image       = "370137866648.dkr.ecr.us-east-1.amazonaws.com/manager-deliberate:v2" # NOTICE: FILL
  ...
  worker_docker_image          = "370137866648.dkr.ecr.us-east-1.amazonaws.com/worker-deliberate:v2" # NOTICE: FILL
